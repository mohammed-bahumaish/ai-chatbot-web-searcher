...
export const TEST_PROMPTS: Record<string, CoreMessage> = {
  ...
  USER_NEXTJS: {
    role: "user",
    content: [
      { type: "text", text: "Find research papers about quantum computing" },
    ],
  },
  ...
  USER_TEXT_ARTIFACT: {
    ...
    content: [
      {
        type: "text",
        text: "Search for news about renewable energy trends",
      },
    ],
  },
  CREATE_DOCUMENT_TEXT_CALL: {
    ...
    content: [
      {
        type: "text",
        text: "Look up company info for Tesla and their competitors",
      },
    ],
  },
